/**
 * Zero-Database Lead & Analytics Store for PSARA Consultant India
...
const LEADS_KEY = "psara_consultant_india_lead_entries_v1";
const METRICS_KEY = "psara_consultant_india_section_metrics_v1";

const INITIAL_LEADS: LeadEntry[] = [
  {
    id: "lead-101",
    name: "Vikram Singh (Rathore Security)",
    phone: "+91 98280 55443",
    email: "lead1@example.com",
    product: "Rajasthan PSARA License (New Application)",
  ...
  {
    id: "lead-102",
    name: "Sunil Kumar (Apex Guarding)",
    phone: "+91 99291 33221",
    email: "lead2@example.com",
    product: "Maharashtra & Gujarat Multi-State PSARA",
...
const INITIAL_METRICS: SectionMetric[] = [
  ...
  { id: "sec-1", name: "PSARA Pincode & State Eligibility Checker", views: 3250, clicks: 840, lastActive: "4 mins ago" },
  { id: "sec-2", name: "Instant Advisory Call Booking", views: 2890, clicks: 710, lastActive: "15 mins ago" },
  { id: "sec-3", name: "PSARA Fee Structure & Document Checklist", views: 2410, clicks: 590, lastActive: "30 mins ago" },
